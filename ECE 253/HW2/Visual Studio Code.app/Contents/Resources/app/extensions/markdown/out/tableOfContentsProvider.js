...
var TableOfContentsProvider = /** @class */ (function () {
    ...
    TableOfContentsProvider.prototype.buildToc = function (document) {
        return __awaiter(this, void 0, void 0, function () {
            var toc, tokens, _i, _a, heading, lineNumber, line, href, level;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        toc = [];
    ...
    TableOfContentsProvider.getHeaderLevel = function (markup) {
        if (markup === '=') {
            return 1;
        }
        else if (markup === '-') {
...
//# sourceMappingURL=https://ticino.blob.core.windows.net/sourcemaps/b813d12980308015bcd2b3a2f6efa5c810c33ba5/extensions/markdown/out/tableOfContentsProvider.js.map
