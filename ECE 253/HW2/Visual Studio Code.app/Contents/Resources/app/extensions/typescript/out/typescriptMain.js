...
class TypeScriptServiceClientHost {
    ...
    goToProjectConfig(isTypeScriptProject, resource) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const res = yield this.client.execute('projectInfo', { file, needFileNameList: false });
            if (!res || !res.body) {
            ...
            switch (selected && selected.id) {
                case ProjectConfigAction.CreateConfig:
                    tsconfig_1.openOrCreateConfigFile(isTypeScriptProject, rootPath);
                    return;
...
//# sourceMappingURL=https://ticino.blob.core.windows.net/sourcemaps/b813d12980308015bcd2b3a2f6efa5c810c33ba5/extensions/typescript/out/typescriptMain.js.map
