...
class TypeScriptRefactorProvider {
    ...
    selectRefactoring(document, file, info, range) {
        return __awaiter(this, void 0, void 0, function* () {
            const selected = yield vscode_1.window.showQuickPick(info.actions.map((action) => ({
                label: action.name,
...
//# sourceMappingURL=https://ticino.blob.core.windows.net/sourcemaps/b813d12980308015bcd2b3a2f6efa5c810c33ba5/extensions/typescript/out/features/refactorProvider.js.map
