...
typeof(Env,bin(E1,Bop,E2),int) :- typeof(Env,E1,int), int_op(Bop), typeof(Env,E2,int).

% bin(const(2),leq,const(3)) bool
typeof(Env,bin(E1,Bop,E2),bool) :- typeof(Env,E1,int), comp_op(Bop), typeof(Env,E2,int).

typeof(Env,bin(E1,Bop,E2),bool) :- typeof(Env,E1,bool), bool_op(Bop), typeof(Env,E2,bool).
