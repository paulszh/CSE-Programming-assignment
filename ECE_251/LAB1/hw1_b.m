...
title('Figure 5, linear amplitude of H(k) vs. f');
...
title('Figure 6, linear phase of H(k) vs. f');
ylabel('Amplitude of H(k)');
xlabel('f(radian/sample)');
axis([0 pi -2 2]);
...
title('Figure 7, linear amplitude of H1(k) vs. f');
ylabel('Amplitude of H(k)');
xlabel('f(radian/sample)');
axis([0 pi -2 2]);
...
title('Figure 8, linear phase of H1(k) vs. f');
ylabel('Amplitude of H(k)');
xlabel('f(radian/sample)');
axis([0 pi -2 2]);

saveas(tosave, 'partb_1.jpg');
...
title('Figure 11, linear amplitude of H1(k) vs. f');
...
title('Figure 12, linear phase of H1(k) vs. f');
ylabel('Phase of H1(k)');
xlabel('f(radian/sample)');
axis([0 pi -2 2]);
saveas(tosave, 'partB_2&3.jpg');
...
title('Figure 15, linear amplitude of H2(k) vs. f');
...
title('Figure 16, linear phase of H2(k) vs. f');
ylabel('Phase of H2(k)');
xlabel('f(radian/sample)');
axis([0 pi -2 2]);
saveas(tosave, 'partB_4&5.jpg');
