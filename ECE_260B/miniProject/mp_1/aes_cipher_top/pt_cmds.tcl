...
proc PtCellsensitivitySize { cell } {
	set sensitivity 0.0
    set cellName [get_attri $cell base_name]
    set libcell [get_lib_cells -of_objects $cellName]
    set libcellName [get_attri $libcell base_name]
...
proc sortCellssensitivity { cell_collection } {
  
    foreach_in_collection cell $cell_collection {
        set sensitivity1 [PtCellsensitivityVt $cell]
        set sensitivity2 [PtCellsensitivitySize $cell]
